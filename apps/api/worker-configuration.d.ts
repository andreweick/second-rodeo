/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e51efa8f1d9f55b2dacb8e965737e481)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AUTH_TOKEN: SecretsStoreSecret;
		CLOUDFLARE_MEDIA_TOKEN: SecretsStoreSecret;
		GOOGLE_PLACES_API: SecretsStoreSecret;
		JSON_QUEUE: Queue;
		ASSETS: Fetcher;
	}
}
